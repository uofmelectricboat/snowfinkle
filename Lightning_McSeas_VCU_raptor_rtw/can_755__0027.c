...
uint8_T txData_80__0012[1U][2U];
uint32_T txID_80__0012[1U];
uint8_T txExt_80__0012[1U];
uint8_T txLen_80__0012[1U];
uint8_T txQHead_80__0012 = 0;
uint8_T txQTail_80__0012 = 0;

/* <S6>/raptor_can_txmsg3 */
uint8_T txData_81__0012[1U][2U];
uint32_T txID_81__0012[1U];
uint8_T txExt_81__0012[1U];
uint8_T txLen_81__0012[1U];
uint8_T txQHead_81__0012 = 0;
uint8_T txQTail_81__0012 = 0;

/* <S6>/raptor_can_txmsg1 */
uint8_T txData_79__0012[1U][2U];
uint32_T txID_79__0012[1U];
uint8_T txExt_79__0012[1U];
uint8_T txLen_79__0012[1U];
uint8_T txQHead_79__0012 = 0;
uint8_T txQTail_79__0012 = 0;

/* <S6>/raptor_can_txmsg */
uint8_T txData_78__0012[1U][2U];
uint32_T txID_78__0012[1U];
uint8_T txExt_78__0012[1U];
uint8_T txLen_78__0012[1U];
uint8_T txQHead_78__0012 = 0;
uint8_T txQTail_78__0012 = 0;
...
/* Functions */
void pre_start_CAN_755__0027(void)
{
}                                      // end pre_start_CAN_755__0027
...
void can_send_80__0012(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_755__0027) {
    pre_start_CAN_755__0027();
  }

  send_can_message(CAN1, extended, id, data, length);
}

void can_update_80__0012(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_80__0012(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_81__0012(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_755__0027) {
    pre_start_CAN_755__0027();
...
void can_update_81__0012(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_81__0012(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_79__0012(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_755__0027) {
    pre_start_CAN_755__0027();
...
void can_update_79__0012(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_79__0012(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_78__0012(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_755__0027) {
    pre_start_CAN_755__0027();
...
void can_update_78__0012(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_78__0012(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_755__0027(boolean extended, uint32_t id, uint8_t * data,
  uint8_t data_len)
{
  if (extended == 0) {
...
void post_start_CAN_755__0027(void)
{
  if (started_755__0027) {
    return;
  }
  ...
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_755__0027 );
}                                      // end post_start_CAN_755__0027
