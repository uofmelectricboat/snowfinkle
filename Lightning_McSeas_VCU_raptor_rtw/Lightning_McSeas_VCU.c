 ...
 * C/C++ source code generated on : Sun Nov  6 17:27:16 2022
 *
...
void Lightning_McSeas_VCU_Foreground(void)
{
   ...
   */
  rtb_Gain = rtb_raptor_can_rxmsg_o2 * rtb_Merge_d * -3.128;
   ...
   *  Product: '<S11>/Product'
   */
  rtb_Gain = rtb_raptor_can_rxmsg_o3 * rtb_Merge_d * 3.128;
