...
#ifndef __CAN_492__0006_H
#define __CAN_492__0006_H
...
/* FUNCTION PROTOTYPES */
/* CAN initialization */
extern void pre_start_CAN_492__0006(void);
extern void post_start_CAN_492__0006(void);
...
extern void can_send_39__0006(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);
extern void can_update_39__0006(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);
extern uint32_T can_set_period_39__0006(uint32_T period);
