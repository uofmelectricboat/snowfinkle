...
/* <S7>/raptor_can_txmsg */
uint8_T txData_8__0002[1U][8U];
uint32_T txID_8__0002[1U];
uint8_T txExt_8__0002[1U];
uint8_T txLen_8__0002[1U];
uint8_T txQHead_8__0002 = 0;
uint8_T txQTail_8__0002 = 0;

/* <S8>/raptor_can_txmsg */
uint8_T txData_14__0002[1U][8U];
uint32_T txID_14__0002[1U];
uint8_T txExt_14__0002[1U];
uint8_T txLen_14__0002[1U];
uint8_T txQHead_14__0002 = 0;
uint8_T txQTail_14__0002 = 0;
...
/* <S12>/raptor_can_txmsg */
uint8_T txData_420__0005[1U][8U];
uint32_T txID_420__0005[1U];
uint8_T txExt_420__0005[1U];
uint8_T txLen_420__0005[1U];
uint8_T txQHead_420__0005 = 0;
uint8_T txQTail_420__0005 = 0;

/* <S12>/raptor_can_txmsg1 */
uint8_T txData_421__0002[1U][8U];
uint32_T txID_421__0002[1U];
uint8_T txExt_421__0002[1U];
uint8_T txLen_421__0002[1U];
uint8_T txQHead_421__0002 = 0;
uint8_T txQTail_421__0002 = 0;

/* <S26>/raptor_can_txmsg */
uint8_T txData_459__0002[1U][8U];
uint32_T txID_459__0002[1U];
uint8_T txExt_459__0002[1U];
uint8_T txLen_459__0002[1U];
uint8_T txQHead_459__0002 = 0;
uint8_T txQTail_459__0002 = 0;
...
/* Functions */
void pre_start_CAN_909__0001(void)
{
}                                      // end pre_start_CAN_909__0001
...
void can_send_8__0002(uint32_T id, uint8_T extended, uint8_T length, const
                      uint8_T *data)
{
  if (!started_909__0001) {
    pre_start_CAN_909__0001();
  }

  send_can_message(CAN1, extended, id, data, length);
}

void can_update_8__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_8__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_14__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_909__0001) {
    pre_start_CAN_909__0001();
...
void can_update_14__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_14__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_420__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_909__0001) {
    pre_start_CAN_909__0001();
...
void can_update_420__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_420__0005(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_421__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_909__0001) {
    pre_start_CAN_909__0001();
...
void can_update_421__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_421__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_459__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_909__0001) {
    pre_start_CAN_909__0001();
...
void can_update_459__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_459__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_909__0001(boolean extended, uint32_t id, uint8_t * data,
  uint8_t data_len)
{
  if (extended == 0) {
...
void post_start_CAN_909__0001(void)
{
  if (started_909__0001) {
    return;
  }
  ...
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_909__0001 );
}                                      // end post_start_CAN_909__0001
