...
/* <S7>/raptor_can_txmsg */
uint8_T txData_39__0006[1U][8U];
uint32_T txID_39__0006[1U];
uint8_T txExt_39__0006[1U];
uint8_T txLen_39__0006[1U];
uint8_T txQHead_39__0006 = 0;
uint8_T txQTail_39__0006 = 0;
...
/* Functions */
void pre_start_CAN_492__0006(void)
{
}                                      // end pre_start_CAN_492__0006
...
void can_send_8__0006(uint32_T id, uint8_T extended, uint8_T length, const
                      uint8_T *data)
{
  if (!started_492__0006) {
    pre_start_CAN_492__0006();
  }
...
void can_send_39__0006(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_492__0006) {
    pre_start_CAN_492__0006();
...
void can_update_39__0006(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_39__0006(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_492__0006(boolean extended, uint32_t id, uint8_t * data,
  uint8_t data_len)
{
  if (extended == 0) {
...
void post_start_CAN_492__0006(void)
{
  if (started_492__0006) {
    return;
  }
  ...
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_492__0006 );
}                                      // end post_start_CAN_492__0006
