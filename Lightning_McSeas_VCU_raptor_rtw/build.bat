...
set LDFILES=objs\LIN2.o objs\Lightning_McSeas_VCU.o objs\Timer_BGND_9AY_V.o objs\Timer_ooqlV.o objs\XCP_App.o objs\can_755__0027.o objs\can_756__0027.o objs\data.o objs\hw_user.o objs\lin_757__0027.o objs\lin_general.o objs\raptor_printf.o objs\xcp_protocol.o 
...
echo powerpc-eabivle-gcc "@compiler.args" -o "./objs/Lightning_McSeas_VCU.o" Lightning_McSeas_VCU.c 
powerpc-eabivle-gcc "@compiler.args" -o "./objs/Lightning_McSeas_VCU.o" Lightning_McSeas_VCU.c 
...
echo powerpc-eabivle-gcc "@compiler.args" -o "./objs/can_755__0027.o" can_755__0027.c 
powerpc-eabivle-gcc "@compiler.args" -o "./objs/can_755__0027.o" can_755__0027.c 
echo powerpc-eabivle-gcc "@compiler.args" -o "./objs/can_756__0027.o" can_756__0027.c 
powerpc-eabivle-gcc "@compiler.args" -o "./objs/can_756__0027.o" can_756__0027.c 
...
echo powerpc-eabivle-gcc "@compiler.args" -o "./objs/lin_757__0027.o" lin_757__0027.c 
powerpc-eabivle-gcc "@compiler.args" -o "./objs/lin_757__0027.o" lin_757__0027.c 
...
echo Linking Lightning_McSeas_VCU ...
powerpc-eabivle-gcc -o Lightning_McSeas_VCU.elf "@hw_linker.args"
if %ERRORLEVEL% NEQ 0 exit /B %ERRORLEVEL%
powerpc-eabivle-objcopy -I elf32-powerpc -O ihex Lightning_McSeas_VCU.elf Lightning_McSeas_VCU.hex
powerpc-eabivle-nm -a Lightning_McSeas_VCU.elf > Lightning_McSeas_VCU.sym
echo Copy : Lightning_McSeas_VCU.hex 
copy Lightning_McSeas_VCU.hex "C:\Users\jerod\OneDrive\Documents\School-Files\Boat_Team\GitHubFiles\Lightning_McSeas_VCU_raptor_rtw\Lightning_McSeas_VCU_019.hex" /Y
