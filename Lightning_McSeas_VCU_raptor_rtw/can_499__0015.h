...
#ifndef __CAN_499__0015_H
#define __CAN_499__0015_H
...
/* FUNCTION PROTOTYPES */
/* CAN initialization */
extern void pre_start_CAN_499__0015(void);
extern void post_start_CAN_499__0015(void);
...
extern void can_send_14__0015(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);
extern void can_update_14__0015(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);
extern uint32_T can_set_period_14__0015(uint32_T period);
extern void can_send_27__0015(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);
extern void can_update_27__0015(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);
extern uint32_T can_set_period_27__0015(uint32_T period);
extern void can_send_49__0015(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);
extern void can_update_49__0015(uint32_T id, uint8_T extended, uint8_T length,
  const uint8_T *data);
extern uint32_T can_set_period_49__0015(uint32_T period);
