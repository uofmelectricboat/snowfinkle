...
/* <S7>/raptor_can_txmsg */
uint8_T txData_14__0015[1U][8U];
uint32_T txID_14__0015[1U];
uint8_T txExt_14__0015[1U];
uint8_T txLen_14__0015[1U];
uint8_T txQHead_14__0015 = 0;
uint8_T txQTail_14__0015 = 0;

/* <S9>/raptor_can_txmsg */
uint8_T txData_27__0015[1U][2U];
uint32_T txID_27__0015[1U];
uint8_T txExt_27__0015[1U];
uint8_T txLen_27__0015[1U];
uint8_T txQHead_27__0015 = 0;
uint8_T txQTail_27__0015 = 0;

/* <S10>/raptor_can_txmsg */
uint8_T txData_49__0015[1U][8U];
uint32_T txID_49__0015[1U];
uint8_T txExt_49__0015[1U];
uint8_T txLen_49__0015[1U];
uint8_T txQHead_49__0015 = 0;
uint8_T txQTail_49__0015 = 0;
...
/* Functions */
void pre_start_CAN_499__0015(void)
{
}                                      // end pre_start_CAN_499__0015
...
void can_send_14__0015(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_499__0015) {
    pre_start_CAN_499__0015();
  }

  send_can_message(CAN1, extended, id, data, length);
}

void can_update_14__0015(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_14__0015(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_27__0015(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_499__0015) {
    pre_start_CAN_499__0015();
...
void can_update_27__0015(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_27__0015(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_49__0015(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_499__0015) {
    pre_start_CAN_499__0015();
...
void can_update_49__0015(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_49__0015(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_499__0015(boolean extended, uint32_t id, uint8_t * data,
  uint8_t data_len)
{
  if (extended == 0) {
...
void post_start_CAN_499__0015(void)
{
  if (started_499__0015) {
    return;
  }
  ...
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_499__0015 );
}                                      // end post_start_CAN_499__0015
