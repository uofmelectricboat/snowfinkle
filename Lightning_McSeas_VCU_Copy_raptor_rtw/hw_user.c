...
void Thread_ModelStep()
{
  if (!app_is_in_shutdown) {
    Lightning_McSeas_VCU_Copy_step();
...
void application_int(void)
{
  ...
  Lightning_McSeas_VCU_Copy_initialize();
  ...
  pre_start_CAN_753__0002();           /* <Root>/raptor_can_def */
  CANFrame_Queue_Create(&g_CAN2_TxQueue, CAN2_TxQueue_data, (20));
  CANFrame_Queue_Create(&g_CAN2_RxQueue, CAN2_RxQueue_data, (16));
  pre_start_CAN_754__0002();           /* <Root>/raptor_can_def1 */

  /* start_CAN(); */
  post_start_CAN_753__0002();          /* <Root>/raptor_can_def */
  post_start_CAN_754__0002();          /* <Root>/raptor_can_def1 */
  Xcp_Initialize();
  ...
  extern uint8_t g_Thread_Foreground_Idx;
  g_Thread_Foreground_Idx = add_task(&Thread_Foreground, 25000, TRUE_TIMED);
  extern uint8_t g_Thread_Background_Idx;
