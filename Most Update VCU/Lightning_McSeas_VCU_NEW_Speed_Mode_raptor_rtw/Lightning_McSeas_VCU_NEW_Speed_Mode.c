 ...
 *
 * File: Lightning_McSeas_VCU_NEW_Speed_Mode.c
 *
...
void Lightning_McSeas_VCU_NEW_Speed_Mode_Background_Init(void)
{
  ...
  Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.raptor_delta_time_DWORK1 = ticks();

  /* InitializeConditions for UnitDelay: '<S56>/Unit Delay' */
  Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay_DSTATE = 1U;

  /* InitializeConditions for UnitDelay: '<S57>/init = 1' */
  Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.init1_DSTATE = true;
  Lightning_McSeas_VCU_NEW_Speed_Mode_PrevZCSigState.RaiseShutdownEvent_Trig_ZCE
    = POS_ZCSIG;

  /* End of SystemInitialize for SubSystem: '<S42>/Raise Shutdown Event' */
  Lightning_McSeas_VCU_NEW_Speed_Mode_PrevZCSigState.RaiseStartupEvent_Trig_ZCE =
    ZERO_ZCSIG;
...
void Lightning_McSeas_VCU_NEW_Speed_Mode_Background_Reset(void)
{
  /* InitializeConditions for S-Function (raptor_sfun_delta_time): '<S56>/raptor_delta_time' */
  Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.raptor_delta_time_DWORK1 = ticks();
...
void Lightning_McSeas_VCU_NEW_Speed_Mode_Background(void)
{
  ...
  rtb_RelationalOperator = (rtb_raptor_lin_state_o2 ==
    Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.DelayInput1_DSTATE);
  ...
  if (!rtb_Compare_n) {
     ...
     */
    if (Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay2_DSTATE ||
        (!rtb_RelationalOperator)) {
      rtb_MultiportSwitch1 =
        Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay1_DSTATE;
    } else {
      rtb_MultiportSwitch1 =
        Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay1_DSTATE + 1U;
    }
  ...
  rtb_Compare_n = (rtb_raptor_can_state1_o2 !=
                   Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.DelayInput1_DSTATE_j);
  ...
  if (!rtb_Compare_n) {
     ...
     */
    if (Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay2_DSTATE_b ||
        rtb_Compare_n) {
      rtb_MultiportSwitch1_a =
        Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay1_DSTATE_m;
    } else {
      rtb_MultiportSwitch1_a =
        Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay1_DSTATE_m + 1U;
    }
  ...
  /* S-Function (raptor_sfun_delta_time): '<S56>/raptor_delta_time' */
  {
    rtb_raptor_delta_time = GetDeltaTime_ms((uint32_t*)
      &Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.raptor_delta_time_DWORK1);
  }
  ...
  if (rtb_RelationalOperator1 ==
      Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.DelayInput1_DSTATE_o) {
    rtb_MultiportSwitch1_b = rtb_raptor_delta_time +
      Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay_DSTATE;
  } else {
  ...
  if (rtb_RelationalOperator1 || (rtb_MultiportSwitch1_b < (KeySwLoTimeThr_Data())))
  {
    ...
    if (!rtb_RelationalOperator1) {
      rtb_MultiportSwitch_d =
        Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay_DSTATE_i;
    } else {
  ...
  if (!rtb_KeepOnrequestiscurrentlytrue) {
     ...
     */
    if (Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay2_DSTATE_j) {
      rtb_MultiportSwitch1_p =
        Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay1_DSTATE_a;
    } else {
      rtb_MultiportSwitch1_p =
        Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay1_DSTATE_a + 1U;
    }
  ...
  if (!rtb_LogicalOperator3_m) {
    ...
    if (!rtb_KeepOnrequestiscurrentlytrue) {
      rtb_MultiportSwitch_ko =
        Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay_DSTATE_ik;
    } else {
  ...
  rtb_UnitDelay_l = Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay_DSTATE_a;

  /* Outputs for Triggered SubSystem: '<S42>/Store EEPROM' incorporates:
   *  TriggerPort: '<S47>/Trigger'
   */
  if ((!Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay_DSTATE_a) &&
      (Lightning_McSeas_VCU_NEW_Speed_Mode_PrevZCSigState.StoreEEPROM_Trig_ZCE
       != ZERO_ZCSIG)) {
  ...
  rtb_LogicalOperator2_e = (rtb_raptor_sfun_nv_status ||
    rtb_KeepOnrequestiscurrentlytrue ||
    Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay1_DSTATE_o);
  ...
  if (Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.init1_DSTATE) {
  ...
  Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay2_DSTATE =
    rtb_RelationalOperator;
  ...
  Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay2_DSTATE_b =
  ...
  Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay2_DSTATE_j =
  ...
  Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.UnitDelay_DSTATE_a =
    rtb_KeepOnrequestiscurrentlytrue;
   ...
   */
  Lightning_McSeas_VCU_NEW_Speed_Mode_DWork.init1_DSTATE = false;
}

/* System initialize for function-call system: '<Root>/Foreground' */
void Lightning_McSeas_VCU_NEW_Speed_Mode_Foreground_Init(void)
{
...
void Lightning_McSeas_VCU_NEW_Speed_Mode_Foreground_Enable(void)
{
  ...
  can_set_period_2241__0001(0U);

  /* Enable for S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg2' incorporates:
   *  Constant: '<S11>/Constant2'
   */
  /* Level2 S-Function Block: '<S11>/raptor_can_txmsg2' (raptor_sfun_can_txmsg) */
  can_set_period_2531__0001(0U);

  /* Enable for S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg3' incorporates:
   *  Constant: '<S11>/Constant2'
   */
  /* Level2 S-Function Block: '<S11>/raptor_can_txmsg3' (raptor_sfun_can_txmsg) */
  can_set_period_2532__0001(0U);

  /* Enable for S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg' */
  /* Level2 S-Function Block: '<S11>/raptor_can_txmsg' (raptor_sfun_can_txmsg) */
  can_set_period_2529__0004(0U);

  /* Enable for S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg1' */
  /* Level2 S-Function Block: '<S11>/raptor_can_txmsg1' (raptor_sfun_can_txmsg) */
  can_set_period_2530__0001(0U);
  ...
  can_set_period_2566__0001(0U);
}

/* Disable for function-call system: '<Root>/Foreground' */
void Lightning_McSeas_VCU_NEW_Speed_Mode_Foreground_Disable(void)
{
  /* Disable for S-Function (raptor_sfun_can_txmsg): '<S8>/raptor_can_txmsg4' */
  /* Level2 S-Function Block: '<S8>/raptor_can_txmsg4' (raptor_sfun_can_txmsg) */
  can_set_period_2017__0002(0);

  /* Disable for S-Function (raptor_sfun_can_txmsg): '<S8>/raptor_can_txmsg3' */
  /* Level2 S-Function Block: '<S8>/raptor_can_txmsg3' (raptor_sfun_can_txmsg) */
  can_set_period_2016__0005(0);

  /* Disable for S-Function (raptor_sfun_can_txmsg): '<S9>/raptor_can_txmsg1' incorporates:
   *  Constant: '<S9>/Constant1'
   */
  /* Level2 S-Function Block: '<S9>/raptor_can_txmsg1' (raptor_sfun_can_txmsg) */
  can_set_period_2145__0001(0);

  /* Disable for S-Function (raptor_sfun_can_txmsg): '<S10>/raptor_can_txmsg' */
  /* Level2 S-Function Block: '<S10>/raptor_can_txmsg' (raptor_sfun_can_txmsg) */
  can_set_period_2241__0001(0);

  /* Disable for S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg2' incorporates:
   *  Constant: '<S11>/Constant2'
   */
  /* Level2 S-Function Block: '<S11>/raptor_can_txmsg2' (raptor_sfun_can_txmsg) */
  can_set_period_2531__0001(0);

  /* Disable for S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg3' incorporates:
   *  Constant: '<S11>/Constant2'
   */
  /* Level2 S-Function Block: '<S11>/raptor_can_txmsg3' (raptor_sfun_can_txmsg) */
  can_set_period_2532__0001(0);

  /* Disable for S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg' */
  /* Level2 S-Function Block: '<S11>/raptor_can_txmsg' (raptor_sfun_can_txmsg) */
  can_set_period_2529__0004(0);

  /* Disable for S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg1' */
  /* Level2 S-Function Block: '<S11>/raptor_can_txmsg1' (raptor_sfun_can_txmsg) */
  can_set_period_2530__0001(0);

  /* Disable for S-Function (raptor_sfun_can_txmsg): '<S41>/raptor_can_txmsg' */
  /* Level2 S-Function Block: '<S41>/raptor_can_txmsg' (raptor_sfun_can_txmsg) */
  can_set_period_2566__0001(0);
}

/* Output and update for function-call system: '<Root>/Foreground' */
void Lightning_McSeas_VCU_NEW_Speed_Mode_Foreground(void)
{
  /* local block i/o variables */
  real_T rtb_raptor_can_rxmsg_o2;
  real_T rtb_raptor_can_rxmsg_o3_l;
  real_T rtb_raptor_can_rxmsg2_o2;
  real_T rtb_Merge;
  real_T rtb_Merge_c;
  real_T rtb_Merge_n;
  real_T rtb_Merge_d;
  ...
  /* S-Function Block:<S7>/raptor_can_rxmsg */
  {
    ...
    uint32_T temp;
    can_get_2552__0001(&rtb_raptor_can_rxmsg_o1, NULL, NULL, &data[0], 8);
  ...
  /* S-Function Block:<S8>/raptor_can_txmsg4 */
  {
    ...
    data[1U] |= temp_shift;
    can_set_period_2017__0002(0U);
    can_send_2017__0002(31U & 0x7FF, 0, 2U, &data[0]);
  }
  ...
  /* S-Function Block:<S8>/raptor_can_txmsg3 */
  {
    ...
    data[1U] |= temp_shift;
    can_set_period_2016__0005(0U);
    can_send_2016__0005(32U & 0x7FF, 0, 2U, &data[0]);
  }
  ...
  /* S-Function Block:<S9>/raptor_can_rxmsg */
  {
    ...
    uint32_T temp;
    can_get_2144__0001(&rtb_raptor_can_rxmsg_o1_i, NULL, NULL, &data[0], 8);
  ...
  /* S-Function Block:<S7>/raptor_can_rxmsg2 */
  {
    ...
    uint32_T temp;
    can_get_2554__0001(&rtb_raptor_can_rxmsg2_o1, NULL, NULL, &data[0], 8);

    /* Signal: Channel_10     */
    temp = 0;
    temp |= ((uint32_T)data[0U]) ;
    temp |= ((uint32_T)data[1U]) << 8;
    rtb_raptor_can_rxmsg2_o2 = (((real_T) temp ) + (real_T)-1230.0);

    /* Signal: Channel_9      */
    temp = 0;
    temp |= ((uint32_T)data[2U]) ;
    temp |= ((uint32_T)data[3U]) << 8;
    rtb_Merge_c = (((real_T) temp ) + (real_T)-1230.0);
  ...
  /* S-Function Block:<S9>/raptor_can_txmsg1 */
  {
    ...
    data[0U] |= temp_shift;
    can_set_period_2145__0001(0U);
    can_send_2145__0001(403105268U & 0x1FFFFFFF, 1, 8U, &data[0]);
  }
   ...
   *  Merge: '<S25>/Merge'
   */
  rtb_Merge_c = (rtb_Merge_c > 1200.0);
  ...
  /* S-Function Block:<S10>/raptor_can_txmsg */
  {
    ...
    if (rtb_Merge_c < 0.0000000000F)
      temp = (uint32_T)0U;
    else if (rtb_Merge_c > 1.0000000000F)
      temp = (uint32_T)1U;
    else {
      if ((real_T)rtb_Merge_c < 0)
        temp = (uint32_T)(int32_T)((rtb_Merge_c));
      else
        temp = (uint32_T)((rtb_Merge_c));
    }
    ...
    data[0U] |= temp_shift;
    can_set_period_2241__0001(0U);
    can_send_2241__0001(1024U & 0x7FF, 0, 4U, &data[0]);
  }

  /* If: '<S31>/If' */
  if (rtb_raptor_can_rxmsg2_o2 > 1200.0) {
  ...
  /* S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg2' incorporates:
   *  Constant: '<S11>/Constant2'
   */

  /* S-Function Block:<S11>/raptor_can_txmsg2 */
  {
    uint8_T data[8U] = { 0, 0, 0, 0, 0, 0, 0, 0, };
    ...
    data[0U] |= temp_shift;
    can_set_period_2531__0001(0U);
    can_send_2531__0001(0U & 0x7FF, 0, 8U, &data[0]);
  }

  /* If: '<S33>/If' */
  if (rtb_raptor_can_rxmsg2_o2 > 250.0) {
  ...
  /* S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg3' incorporates:
   *  Constant: '<S11>/Constant2'
   */

  /* S-Function Block:<S11>/raptor_can_txmsg3 */
  {
    uint8_T data[8U] = { 0, 0, 0, 0, 0, 0, 0, 0, };
    ...
    data[0U] |= temp_shift;
    can_set_period_2532__0001(0U);
    can_send_2532__0001(0U & 0x7FF, 0, 8U, &data[0]);
  }
  ...
  /* S-Function Block:<S7>/raptor_can_rxmsg1 */
  {
    ...
    uint32_T temp;
    can_get_2553__0001(&rtb_raptor_can_rxmsg1_o1, NULL, NULL, &data[0], 8);
   ...
   */
  rtb_Gain2 = rtb_raptor_can_rxmsg_o2 * rtb_Merge_d * -2.0;
  ...
  /* S-Function Block:<S11>/raptor_can_txmsg */
  {
    ...
    data[1U] |= temp_shift;
    can_set_period_2529__0004(0U);
    can_send_2529__0004(550U & 0x7FF, 0, 8U, &data[0]);
  }

  /* Gain: '<S11>/Gain1' incorporates:
   *  Product: '<S11>/Product'
   */
  rtb_Gain2 = rtb_raptor_can_rxmsg_o3_l * rtb_Merge_d * 2.0;

  /* S-Function (raptor_sfun_can_txmsg): '<S11>/raptor_can_txmsg1' */
  ...
  /* S-Function Block:<S11>/raptor_can_txmsg1 */
  {
    ...
    data[1U] |= temp_shift;
    can_set_period_2530__0001(0U);
    can_send_2530__0001(550U & 0x7FF, 0, 8U, &data[0]);
  }
  ...
  /* S-Function Block:<S41>/raptor_can_txmsg */
  {
    ...
    data[0U] |= temp_shift;
    can_set_period_2566__0001(0U);
    can_send_2566__0001(1306U & 0x7FF, 0, 8U, &data[0]);
  }
}

/* Model step function */
void Lightning_McSeas_VCU_NEW_Speed_Mode_step(void)
{
...
void Lightning_McSeas_VCU_NEW_Speed_Mode_initialize(void)
{
  /* Registration code */

  /* states (dwork) */
  (void) memset((void *)&Lightning_McSeas_VCU_NEW_Speed_Mode_DWork, 0,
                sizeof(D_Work_Lightning_McSeas_VCU_NEW_Speed_Mode));
   ...
   */
  Lightning_McSeas_VCU_NEW_Speed_Mode_Foreground_Init();
   ...
   */
  Lightning_McSeas_VCU_NEW_Speed_Mode_Background_Init();
  ...
  /* Enable Subsystem */
  Lightning_McSeas_VCU_NEW_Speed_Mode_Foreground_Enable();
...
void Lightning_McSeas_VCU_NEW_Speed_Mode_terminate(void)
{
