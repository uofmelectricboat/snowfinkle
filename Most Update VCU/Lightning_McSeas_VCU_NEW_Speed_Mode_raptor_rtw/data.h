...
typedef struct {
  uint8_T const ModelName[35];         /* Type : uint8_T, Storage : CONST,  */
  ...
  uint8_T const SwIdTxt[39];           /* Type : uint8_T, Storage : CONST,  */
  uint8_T const CalIdTxt[43];          /* Type : uint8_T, Storage : CONST,  */
...
#define ModelName_ELEMENTS()           (1 * 35)
