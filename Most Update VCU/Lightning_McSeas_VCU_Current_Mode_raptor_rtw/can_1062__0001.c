...
uint8_T txData_176__0002[1U][8U];
uint32_T txID_176__0002[1U];
uint8_T txExt_176__0002[1U];
uint8_T txLen_176__0002[1U];
uint8_T txQHead_176__0002 = 0;
uint8_T txQTail_176__0002 = 0;

/* <S9>/raptor_can_txmsg3 */
uint8_T txData_177__0002[1U][8U];
uint32_T txID_177__0002[1U];
uint8_T txExt_177__0002[1U];
uint8_T txLen_177__0002[1U];
uint8_T txQHead_177__0002 = 0;
uint8_T txQTail_177__0002 = 0;

/* <S10>/raptor_can_txmsg */
uint8_T txData_285__0002[1U][4U];
uint32_T txID_285__0002[1U];
uint8_T txExt_285__0002[1U];
uint8_T txLen_285__0002[1U];
uint8_T txQHead_285__0002 = 0;
uint8_T txQTail_285__0002 = 0;

/* <S11>/raptor_can_txmsg */
uint8_T txData_573__0004[1U][8U];
uint32_T txID_573__0004[1U];
uint8_T txExt_573__0004[1U];
uint8_T txLen_573__0004[1U];
uint8_T txQHead_573__0004 = 0;
uint8_T txQTail_573__0004 = 0;

/* <S11>/raptor_can_txmsg1 */
uint8_T txData_574__0001[1U][8U];
uint32_T txID_574__0001[1U];
uint8_T txExt_574__0001[1U];
uint8_T txLen_574__0001[1U];
uint8_T txQHead_574__0001 = 0;
uint8_T txQTail_574__0001 = 0;

/* <S38>/raptor_can_txmsg */
uint8_T txData_612__0001[1U][8U];
uint32_T txID_612__0001[1U];
uint8_T txExt_612__0001[1U];
uint8_T txLen_612__0001[1U];
uint8_T txQHead_612__0001 = 0;
uint8_T txQTail_612__0001 = 0;
...
/* Functions */
void pre_start_CAN_1062__0001(void)
{
}                                      // end pre_start_CAN_1062__0001
...
void can_send_72__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1062__0001) {
    pre_start_CAN_1062__0001();
  }
...
void can_send_176__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1062__0001) {
    pre_start_CAN_1062__0001();
...
void can_update_176__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_176__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_177__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1062__0001) {
    pre_start_CAN_1062__0001();
...
void can_update_177__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_177__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_285__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1062__0001) {
    pre_start_CAN_1062__0001();
...
void can_update_285__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_285__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_573__0004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1062__0001) {
    pre_start_CAN_1062__0001();
...
void can_update_573__0004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_573__0004(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_574__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1062__0001) {
    pre_start_CAN_1062__0001();
...
void can_update_574__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_574__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_612__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1062__0001) {
    pre_start_CAN_1062__0001();
...
void can_update_612__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_612__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_1062__0001(boolean extended, uint32_t id, uint8_t *
...
void post_start_CAN_1062__0001(void)
{
  if (started_1062__0001) {
    return;
  }

  started_1062__0001 = 1;
  start_CAN(CAN1, CAN_CAN1_baud_rate );
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_1062__0001 );
}                                      // end post_start_CAN_1062__0001
