...
void rxFn_585__0005(unsigned int id, uint8_T len, uint8_T* data);
uint8_T rxBuf_585__0005[1U][8];
uint8_T rxLen_585__0005[1U];
uint16_T rxAge_585__0005;
uint32_T rxID_585__0005[1U];
uint8_T rxQHead_585__0005 = 0;
uint8_T rxQTail_585__0005 = 0;

/* Block: <S10>/raptor_can_rxmsg1 */
void rxFn_1454__0035(unsigned int id, uint8_T len, uint8_T* data);
uint8_T rxBuf_1454__0035[1U][8];
uint8_T rxLen_1454__0035[1U];
uint16_T rxAge_1454__0035;
uint32_T rxID_1454__0035[1U];
uint8_T rxQHead_1454__0035 = 0;
uint8_T rxQTail_1454__0035 = 0;
...
uint8_T txData_589__0005[1U][8U];
uint32_T txID_589__0005[1U];
uint8_T txExt_589__0005[1U];
uint8_T txLen_589__0005[1U];
uint8_T txQHead_589__0005 = 0;
uint8_T txQTail_589__0005 = 0;

/* <S10>/raptor_can_txmsg2 */
uint8_T txData_586__0005[1U][8U];
uint32_T txID_586__0005[1U];
uint8_T txExt_586__0005[1U];
uint8_T txLen_586__0005[1U];
uint8_T txQHead_586__0005 = 0;
uint8_T txQTail_586__0005 = 0;
...
/* <S6>/raptor_can_txmsg */
uint8_T txData_622__0005[1U][8U];
uint32_T txID_622__0005[1U];
uint8_T txExt_622__0005[1U];
uint8_T txLen_622__0005[1U];
uint8_T txQHead_622__0005 = 0;
uint8_T txQTail_622__0005 = 0;
...
/* Functions */
void pre_start_CAN_1072__0034(void)
{
}                                      // end pre_start_CAN_1072__0034

void rxFn_585__0005(unsigned int id, uint8_T length, uint8_T* data)
{
  uint8_T i;
  uint8_T* b = data;
  if ((length == 8U) ) {
    for (i = 0; i < length; i++) {
      rxBuf_585__0005[rxQHead_585__0005][i] = b[i];
    }

    rxLen_585__0005[rxQHead_585__0005] = length;
    rxID_585__0005[rxQHead_585__0005] = id;
    if ((rxQHead_585__0005 == rxQTail_585__0005) && (rxAge_585__0005 == 0))
      rxQTail_585__0005 = (rxQTail_585__0005 + 1) % 1U;
    if ((rxQHead_585__0005 == (rxQTail_585__0005 + 1)% 1U) && (rxAge_585__0005
         != 0))
      rxQTail_585__0005 = (rxQTail_585__0005 + 1) % 1U;
    rxQHead_585__0005 = (rxQHead_585__0005 + 1 ) % 1U;
    rxAge_585__0005 = 0;
  }
}

uint8_T can_get_585__0005(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  ...
  if (age != NULL)
    *age = rxAge_585__0005;
  if (id != NULL)
    *id = rxID_585__0005[rxQTail_585__0005];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (length > rxLen_585__0005[rxQTail_585__0005])
    length = rxLen_585__0005[rxQTail_585__0005];
  if (data != NULL)
    for (i = 0; i < length; i++)
      data[i] = rxBuf_585__0005[rxQTail_585__0005][i];
  if ((rxQHead_585__0005 != (rxQTail_585__0005 + 1)% 1U) && (rxAge_585__0005 ==
       0))
    rxQTail_585__0005 = (rxQTail_585__0005 + 1) % 1U;
  else if (rxAge_585__0005 < MAX_AGE)
    rxAge_585__0005++;
  return length;
}

void rxFn_1454__0035(unsigned int id, uint8_T length, uint8_T* data)
{
  uint8_T i;
  uint8_T* b = data;
  if ((length == 8U) ) {
    for (i = 0; i < length; i++) {
      rxBuf_1454__0035[rxQHead_1454__0035][i] = b[i];
    }

    rxLen_1454__0035[rxQHead_1454__0035] = length;
    rxID_1454__0035[rxQHead_1454__0035] = id;
    if ((rxQHead_1454__0035 == rxQTail_1454__0035) && (rxAge_1454__0035 == 0))
      rxQTail_1454__0035 = (rxQTail_1454__0035 + 1) % 1U;
    if ((rxQHead_1454__0035 == (rxQTail_1454__0035 + 1)% 1U) &&
        (rxAge_1454__0035 != 0))
      rxQTail_1454__0035 = (rxQTail_1454__0035 + 1) % 1U;
    rxQHead_1454__0035 = (rxQHead_1454__0035 + 1 ) % 1U;
    rxAge_1454__0035 = 0;
  }
}

uint8_T can_get_1454__0035(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  uint8_T i;
  if (age != NULL)
    *age = rxAge_1454__0035;
  if (id != NULL)
    *id = rxID_1454__0035[rxQTail_1454__0035];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (length > rxLen_1454__0035[rxQTail_1454__0035])
    length = rxLen_1454__0035[rxQTail_1454__0035];
  if (data != NULL)
    for (i = 0; i < length; i++)
      data[i] = rxBuf_1454__0035[rxQTail_1454__0035][i];
  if ((rxQHead_1454__0035 != (rxQTail_1454__0035 + 1)% 1U) && (rxAge_1454__0035 ==
       0))
    rxQTail_1454__0035 = (rxQTail_1454__0035 + 1) % 1U;
  else if (rxAge_1454__0035 < MAX_AGE)
    rxAge_1454__0035++;
  return length;
}
...
void can_send_8__0006(uint32_T id, uint8_T extended, uint8_T length, const
                      uint8_T *data)
{
  if (!started_1072__0034) {
    pre_start_CAN_1072__0034();
  }
...
void can_send_589__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1072__0034) {
    pre_start_CAN_1072__0034();
...
void can_update_589__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_589__0005(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_586__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1072__0034) {
    pre_start_CAN_1072__0034();
...
void can_update_586__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_586__0005(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_622__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1072__0034) {
    pre_start_CAN_1072__0034();
...
void can_update_622__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_622__0005(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_1072__0034(boolean extended, uint32_t id, uint8_t *
  data, uint8_t data_len)
{
  ...
  if (!app_is_in_shutdown) {
    if (extended == 0U) {
      if ((id & 0x7FF) == 0x726) {
        rxFn_585__0005(id, data_len, data);
      }
    }
  }
  ...
  if (!app_is_in_shutdown) {
    if (extended == 0U) {
      if ((id & 0x7FF) == 0x727) {
        rxFn_1454__0035(id, data_len, data);
      }
    }
  }
...
void post_start_CAN_1072__0034(void)
{
  if (started_1072__0034) {
    return;
  }

  started_1072__0034 = 1;
  start_CAN(CAN1, CAN_CAN1_baud_rate );
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_1072__0034 );
}                                      // end post_start_CAN_1072__0034
