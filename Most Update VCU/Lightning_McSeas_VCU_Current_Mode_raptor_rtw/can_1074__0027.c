...
void rxFn_199__0006(unsigned int id, uint8_T len, uint8_T* data);
uint8_T rxBuf_199__0006[1U][8];
uint8_T rxLen_199__0006[1U];
uint16_T rxAge_199__0006;
uint32_T rxID_199__0006[1U];
uint8_T rxQHead_199__0006 = 0;
uint8_T rxQTail_199__0006 = 0;
...
uint8_T txData_200__0006[1U][8U];
uint32_T txID_200__0006[1U];
uint8_T txExt_200__0006[1U];
uint8_T txLen_200__0006[1U];
uint8_T txQHead_200__0006 = 0;
uint8_T txQTail_200__0006 = 0;

/* <S10>/raptor_can_txmsg */
uint8_T txData_296__0006[1U][4U];
uint32_T txID_296__0006[1U];
uint8_T txExt_296__0006[1U];
uint8_T txLen_296__0006[1U];
uint8_T txQHead_296__0006 = 0;
uint8_T txQTail_296__0006 = 0;

/* <S11>/raptor_can_txmsg */
uint8_T txData_584__0007[1U][8U];
uint32_T txID_584__0007[1U];
uint8_T txExt_584__0007[1U];
uint8_T txLen_584__0007[1U];
uint8_T txQHead_584__0007 = 0;
uint8_T txQTail_584__0007 = 0;

/* <S11>/raptor_can_txmsg1 */
uint8_T txData_585__0005[1U][8U];
uint32_T txID_585__0005[1U];
uint8_T txExt_585__0005[1U];
uint8_T txLen_585__0005[1U];
uint8_T txQHead_585__0005 = 0;
uint8_T txQTail_585__0005 = 0;

/* <S41>/raptor_can_txmsg */
uint8_T txData_624__0005[1U][8U];
uint32_T txID_624__0005[1U];
uint8_T txExt_624__0005[1U];
uint8_T txLen_624__0005[1U];
uint8_T txQHead_624__0005 = 0;
uint8_T txQTail_624__0005 = 0;
...
/* Functions */
void pre_start_CAN_1074__0027(void)
{
}                                      // end pre_start_CAN_1074__0027

void rxFn_199__0006(unsigned int id, uint8_T length, uint8_T* data)
{
  uint8_T i;
  uint8_T* b = data;
  if ((length == 8U) ) {
    for (i = 0; i < length; i++) {
      rxBuf_199__0006[rxQHead_199__0006][i] = b[i];
    }

    rxLen_199__0006[rxQHead_199__0006] = length;
    rxID_199__0006[rxQHead_199__0006] = id;
    if ((rxQHead_199__0006 == rxQTail_199__0006) && (rxAge_199__0006 == 0))
      rxQTail_199__0006 = (rxQTail_199__0006 + 1) % 1U;
    if ((rxQHead_199__0006 == (rxQTail_199__0006 + 1)% 1U) && (rxAge_199__0006
         != 0))
      rxQTail_199__0006 = (rxQTail_199__0006 + 1) % 1U;
    rxQHead_199__0006 = (rxQHead_199__0006 + 1 ) % 1U;
    rxAge_199__0006 = 0;
  }
}

uint8_T can_get_199__0006(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  ...
  if (age != NULL)
    *age = rxAge_199__0006;
  if (id != NULL)
    *id = rxID_199__0006[rxQTail_199__0006];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (length > rxLen_199__0006[rxQTail_199__0006])
    length = rxLen_199__0006[rxQTail_199__0006];
  if (data != NULL)
    for (i = 0; i < length; i++)
      data[i] = rxBuf_199__0006[rxQTail_199__0006][i];
  if ((rxQHead_199__0006 != (rxQTail_199__0006 + 1)% 1U) && (rxAge_199__0006 ==
       0))
    rxQTail_199__0006 = (rxQTail_199__0006 + 1) % 1U;
  else if (rxAge_199__0006 < MAX_AGE)
    rxAge_199__0006++;
  return length;
}
...
void can_send_72__0006(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1074__0027) {
    pre_start_CAN_1074__0027();
  }
...
void can_send_200__0006(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1074__0027) {
    pre_start_CAN_1074__0027();
...
void can_update_200__0006(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_200__0006(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_296__0006(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1074__0027) {
    pre_start_CAN_1074__0027();
...
void can_update_296__0006(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_296__0006(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_584__0007(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1074__0027) {
    pre_start_CAN_1074__0027();
...
void can_update_584__0007(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_584__0007(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_585__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1074__0027) {
    pre_start_CAN_1074__0027();
...
void can_update_585__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_585__0005(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_624__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1074__0027) {
    pre_start_CAN_1074__0027();
...
void can_update_624__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_624__0005(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_1074__0027(boolean extended, uint32_t id, uint8_t *
  data, uint8_t data_len)
{
  ...
  if (!app_is_in_shutdown) {
    if (extended == 0U) {
      if ((id & 0x7FF) == 0x430) {
        rxFn_199__0006(id, data_len, data);
      }
    }
  }
...
void post_start_CAN_1074__0027(void)
{
  if (started_1074__0027) {
    return;
  }

  started_1074__0027 = 1;
  start_CAN(CAN1, CAN_CAN1_baud_rate );
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_1074__0027 );
}                                      // end post_start_CAN_1074__0027
