...
void rxFn_2088__0001(unsigned int id, uint8_T len, uint8_T* data);
uint8_T rxBuf_2088__0001[1U][8];
uint8_T rxLen_2088__0001[1U];
uint16_T rxAge_2088__0001;
uint32_T rxID_2088__0001[1U];
uint8_T rxQHead_2088__0001 = 0;
uint8_T rxQTail_2088__0001 = 0;

/* Block: <S4>/raptor_can_rxmsg1 */
void rxFn_2089__0001(unsigned int id, uint8_T len, uint8_T* data);
uint8_T rxBuf_2089__0001[1U][8];
uint8_T rxLen_2089__0001[1U];
uint16_T rxAge_2089__0001;
uint32_T rxID_2089__0001[1U];
uint8_T rxQHead_2089__0001 = 0;
uint8_T rxQTail_2089__0001 = 0;

/* Block: <S5>/raptor_can_rxmsg */
void rxFn_2169__0001(unsigned int id, uint8_T len, uint8_T* data);
uint8_T rxBuf_2169__0001[1U][8];
uint8_T rxLen_2169__0001[1U];
uint16_T rxAge_2169__0001;
uint32_T rxID_2169__0001[1U];
uint8_T rxQHead_2169__0001 = 0;
uint8_T rxQTail_2169__0001 = 0;
...
/* <S4>/raptor_can_txmsg */
uint8_T txData_2090__0001[1U][8U];
uint32_T txID_2090__0001[1U];
uint8_T txExt_2090__0001[1U];
uint8_T txLen_2090__0001[1U];
uint8_T txQHead_2090__0001 = 0;
uint8_T txQTail_2090__0001 = 0;

/* <S4>/raptor_can_txmsg1 */
uint8_T txData_2091__0001[1U][8U];
uint32_T txID_2091__0001[1U];
uint8_T txExt_2091__0001[1U];
uint8_T txLen_2091__0001[1U];
uint8_T txQHead_2091__0001 = 0;
uint8_T txQTail_2091__0001 = 0;

/* <S5>/raptor_can_txmsg */
uint8_T txData_2170__0001[1U][4U];
uint32_T txID_2170__0001[1U];
uint8_T txExt_2170__0001[1U];
uint8_T txLen_2170__0001[1U];
uint8_T txQHead_2170__0001 = 0;
uint8_T txQTail_2170__0001 = 0;
...
/* Functions */
void pre_start_CAN_2626__0001(void)
{
}                                      // end pre_start_CAN_2626__0001

void rxFn_2088__0001(unsigned int id, uint8_T length, uint8_T* data)
{
  uint8_T i;
  uint8_T* b = data;
  if ((length == 8U) ) {
    for (i = 0; i < length; i++) {
      rxBuf_2088__0001[rxQHead_2088__0001][i] = b[i];
    }

    rxLen_2088__0001[rxQHead_2088__0001] = length;
    rxID_2088__0001[rxQHead_2088__0001] = id;
    if ((rxQHead_2088__0001 == rxQTail_2088__0001) && (rxAge_2088__0001 == 0))
      rxQTail_2088__0001 = (rxQTail_2088__0001 + 1) % 1U;
    if ((rxQHead_2088__0001 == (rxQTail_2088__0001 + 1)% 1U) &&
        (rxAge_2088__0001 != 0))
      rxQTail_2088__0001 = (rxQTail_2088__0001 + 1) % 1U;
    rxQHead_2088__0001 = (rxQHead_2088__0001 + 1 ) % 1U;
    rxAge_2088__0001 = 0;
  }
}

uint8_T can_get_2088__0001(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  uint8_T i;
  if (age != NULL)
    *age = rxAge_2088__0001;
  if (id != NULL)
    *id = rxID_2088__0001[rxQTail_2088__0001];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (length > rxLen_2088__0001[rxQTail_2088__0001])
    length = rxLen_2088__0001[rxQTail_2088__0001];
  if (data != NULL)
    for (i = 0; i < length; i++)
      data[i] = rxBuf_2088__0001[rxQTail_2088__0001][i];
  if ((rxQHead_2088__0001 != (rxQTail_2088__0001 + 1)% 1U) && (rxAge_2088__0001 ==
       0))
    rxQTail_2088__0001 = (rxQTail_2088__0001 + 1) % 1U;
  else if (rxAge_2088__0001 < MAX_AGE)
    rxAge_2088__0001++;
  return length;
}

void rxFn_2089__0001(unsigned int id, uint8_T length, uint8_T* data)
{
  uint8_T i;
  uint8_T* b = data;
  if ((length == 8U) ) {
    for (i = 0; i < length; i++) {
      rxBuf_2089__0001[rxQHead_2089__0001][i] = b[i];
    }

    rxLen_2089__0001[rxQHead_2089__0001] = length;
    rxID_2089__0001[rxQHead_2089__0001] = id;
    if ((rxQHead_2089__0001 == rxQTail_2089__0001) && (rxAge_2089__0001 == 0))
      rxQTail_2089__0001 = (rxQTail_2089__0001 + 1) % 1U;
    if ((rxQHead_2089__0001 == (rxQTail_2089__0001 + 1)% 1U) &&
        (rxAge_2089__0001 != 0))
      rxQTail_2089__0001 = (rxQTail_2089__0001 + 1) % 1U;
    rxQHead_2089__0001 = (rxQHead_2089__0001 + 1 ) % 1U;
    rxAge_2089__0001 = 0;
  }
}

uint8_T can_get_2089__0001(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  uint8_T i;
  if (age != NULL)
    *age = rxAge_2089__0001;
  if (id != NULL)
    *id = rxID_2089__0001[rxQTail_2089__0001];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (length > rxLen_2089__0001[rxQTail_2089__0001])
    length = rxLen_2089__0001[rxQTail_2089__0001];
  if (data != NULL)
    for (i = 0; i < length; i++)
      data[i] = rxBuf_2089__0001[rxQTail_2089__0001][i];
  if ((rxQHead_2089__0001 != (rxQTail_2089__0001 + 1)% 1U) && (rxAge_2089__0001 ==
       0))
    rxQTail_2089__0001 = (rxQTail_2089__0001 + 1) % 1U;
  else if (rxAge_2089__0001 < MAX_AGE)
    rxAge_2089__0001++;
  return length;
}

void rxFn_2169__0001(unsigned int id, uint8_T length, uint8_T* data)
{
  uint8_T i;
  uint8_T* b = data;
  if ((length == 8U) ) {
    for (i = 0; i < length; i++) {
      rxBuf_2169__0001[rxQHead_2169__0001][i] = b[i];
    }

    rxLen_2169__0001[rxQHead_2169__0001] = length;
    rxID_2169__0001[rxQHead_2169__0001] = id;
    if ((rxQHead_2169__0001 == rxQTail_2169__0001) && (rxAge_2169__0001 == 0))
      rxQTail_2169__0001 = (rxQTail_2169__0001 + 1) % 1U;
    if ((rxQHead_2169__0001 == (rxQTail_2169__0001 + 1)% 1U) &&
        (rxAge_2169__0001 != 0))
      rxQTail_2169__0001 = (rxQTail_2169__0001 + 1) % 1U;
    rxQHead_2169__0001 = (rxQHead_2169__0001 + 1 ) % 1U;
    rxAge_2169__0001 = 0;
  }
}

uint8_T can_get_2169__0001(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  uint8_T i;
  if (age != NULL)
    *age = rxAge_2169__0001;
  if (id != NULL)
    *id = rxID_2169__0001[rxQTail_2169__0001];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (length > rxLen_2169__0001[rxQTail_2169__0001])
    length = rxLen_2169__0001[rxQTail_2169__0001];
  if (data != NULL)
    for (i = 0; i < length; i++)
      data[i] = rxBuf_2169__0001[rxQTail_2169__0001][i];
  if ((rxQHead_2169__0001 != (rxQTail_2169__0001 + 1)% 1U) && (rxAge_2169__0001 ==
       0))
    rxQTail_2169__0001 = (rxQTail_2169__0001 + 1) % 1U;
  else if (rxAge_2169__0001 < MAX_AGE)
    rxAge_2169__0001++;
  return length;
}
...
void can_send_2090__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_2626__0001) {
    pre_start_CAN_2626__0001();
  }

  send_can_message(CAN1, extended, id, data, length);
}

void can_update_2090__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_2090__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_2091__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_2626__0001) {
    pre_start_CAN_2626__0001();
...
void can_update_2091__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_2091__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_2170__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_2626__0001) {
    pre_start_CAN_2626__0001();
...
void can_update_2170__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_2170__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_2626__0001(boolean extended, uint32_t id, uint8_t *
  data, uint8_t data_len)
{
  ...
  if (!app_is_in_shutdown) {
    if (extended == 0U) {
      if ((id & 0x7FF) == 0x430) {
        rxFn_2088__0001(id, data_len, data);
      }
    }
  }
  ...
  if (!app_is_in_shutdown) {
    if (extended == 0U) {
      if ((id & 0x7FF) == 0x431) {
        rxFn_2089__0001(id, data_len, data);
      }
    }
  }
  ...
  if (!app_is_in_shutdown) {
    if (extended == 0U) {
      if ((id & 0x7FF) == 0x430) {
        rxFn_2169__0001(id, data_len, data);
      }
    }
  }
...
void post_start_CAN_2626__0001(void)
{
  if (started_2626__0001) {
    return;
  }

  started_2626__0001 = 1;
  start_CAN(CAN1, CAN_CAN1_baud_rate );
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_2626__0001 );
}                                      // end post_start_CAN_2626__0001
