...
typedef struct {
  uint8_T const ModelName[46];         /* Type : uint8_T, Storage : CONST,  */
  ...
  uint8_T const SwIdTxt[50];           /* Type : uint8_T, Storage : CONST,  */
  uint8_T const CalIdTxt[54];          /* Type : uint8_T, Storage : CONST,  */
...
#define ModelName_ELEMENTS()           (1 * 46)
