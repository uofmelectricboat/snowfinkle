...
copy Lightning_McSeas_VCU.hex "C:\Users\jerod\OneDrive\Documents\School-Files\Boat_Team\GitHubFiles\Lightning_McSeas_VCU_raptor_rtw\Lightning_McSeas_VCU_049.hex" /Y
