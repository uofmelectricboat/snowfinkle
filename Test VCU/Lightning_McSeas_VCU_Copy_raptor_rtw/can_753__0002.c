...
void rxFn_290__0002(unsigned int id, uint8_T len, uint8_T* data);
uint8_T rxBuf_290__0002[1U][8];
uint8_T rxLen_290__0002[1U];
uint16_T rxAge_290__0002;
uint32_T rxID_290__0002[1U];
uint8_T rxQHead_290__0002 = 0;
uint8_T rxQTail_290__0002 = 0;

/* Block: <S5>/raptor_can_rxmsg */
void rxFn_289__0002(unsigned int id, uint8_T len, uint8_T* data);
uint8_T rxBuf_289__0002[1U][8];
uint8_T rxLen_289__0002[1U];
uint16_T rxAge_289__0002;
uint32_T rxID_289__0002[1U];
uint8_T rxQHead_289__0002 = 0;
uint8_T rxQTail_289__0002 = 0;
...
/* <S6>/raptor_can_txmsg2 */
uint8_T txData_78__0002[1U][2U];
uint32_T txID_78__0002[1U];
uint8_T txExt_78__0002[1U];
uint8_T txLen_78__0002[1U];
uint8_T txQHead_78__0002 = 0;
uint8_T txQTail_78__0002 = 0;

/* <S6>/raptor_can_txmsg3 */
uint8_T txData_79__0002[1U][2U];
uint32_T txID_79__0002[1U];
uint8_T txExt_79__0002[1U];
uint8_T txLen_79__0002[1U];
uint8_T txQHead_79__0002 = 0;
uint8_T txQTail_79__0002 = 0;

/* <S6>/raptor_can_txmsg */
uint8_T txData_76__0005[1U][2U];
uint32_T txID_76__0005[1U];
uint8_T txExt_76__0005[1U];
uint8_T txLen_76__0005[1U];
uint8_T txQHead_76__0005 = 0;
uint8_T txQTail_76__0005 = 0;

/* <S6>/raptor_can_txmsg1 */
uint8_T txData_77__0002[1U][2U];
uint32_T txID_77__0002[1U];
uint8_T txExt_77__0002[1U];
uint8_T txLen_77__0002[1U];
uint8_T txQHead_77__0002 = 0;
uint8_T txQTail_77__0002 = 0;

/* <S7>/raptor_can_txmsg */
uint8_T txData_121__0002[1U][4U];
uint32_T txID_121__0002[1U];
uint8_T txExt_121__0002[1U];
uint8_T txLen_121__0002[1U];
uint8_T txQHead_121__0002 = 0;
uint8_T txQTail_121__0002 = 0;

/* <S8>/raptor_can_txmsg */
uint8_T txData_258__0002[1U][8U];
uint32_T txID_258__0002[1U];
uint8_T txExt_258__0002[1U];
uint8_T txLen_258__0002[1U];
uint8_T txQHead_258__0002 = 0;
uint8_T txQTail_258__0002 = 0;

/* <S8>/raptor_can_txmsg1 */
uint8_T txData_259__0002[1U][8U];
uint32_T txID_259__0002[1U];
uint8_T txExt_259__0002[1U];
uint8_T txLen_259__0002[1U];
uint8_T txQHead_259__0002 = 0;
uint8_T txQTail_259__0002 = 0;
...
/* Functions */
void pre_start_CAN_753__0002(void)
{
}                                      // end pre_start_CAN_753__0002

void rxFn_290__0002(unsigned int id, uint8_T length, uint8_T* data)
{
  uint8_T i;
  uint8_T* b = data;
  if ((length == 8U) ) {
    for (i = 0; i < length; i++) {
      rxBuf_290__0002[rxQHead_290__0002][i] = b[i];
    }

    rxLen_290__0002[rxQHead_290__0002] = length;
    rxID_290__0002[rxQHead_290__0002] = id;
    if ((rxQHead_290__0002 == rxQTail_290__0002) && (rxAge_290__0002 == 0))
      rxQTail_290__0002 = (rxQTail_290__0002 + 1) % 1U;
    if ((rxQHead_290__0002 == (rxQTail_290__0002 + 1)% 1U) && (rxAge_290__0002
         != 0))
      rxQTail_290__0002 = (rxQTail_290__0002 + 1) % 1U;
    rxQHead_290__0002 = (rxQHead_290__0002 + 1 ) % 1U;
    rxAge_290__0002 = 0;
  }
}

uint8_T can_get_290__0002(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  ...
  if (age != NULL)
    *age = rxAge_290__0002;
  if (id != NULL)
    *id = rxID_290__0002[rxQTail_290__0002];
  if (extended != NULL)
    *extended = 1U;
  if (length > 8)
    length = 8;
  if (length > rxLen_290__0002[rxQTail_290__0002])
    length = rxLen_290__0002[rxQTail_290__0002];
  if (data != NULL)
    for (i = 0; i < length; i++)
      data[i] = rxBuf_290__0002[rxQTail_290__0002][i];
  if ((rxQHead_290__0002 != (rxQTail_290__0002 + 1)% 1U) && (rxAge_290__0002 ==
       0))
    rxQTail_290__0002 = (rxQTail_290__0002 + 1) % 1U;
  else if (rxAge_290__0002 < MAX_AGE)
    rxAge_290__0002++;
  return length;
}

void rxFn_289__0002(unsigned int id, uint8_T length, uint8_T* data)
{
  uint8_T i;
  uint8_T* b = data;
  if ((length == 8U) ) {
    for (i = 0; i < length; i++) {
      rxBuf_289__0002[rxQHead_289__0002][i] = b[i];
    }

    rxLen_289__0002[rxQHead_289__0002] = length;
    rxID_289__0002[rxQHead_289__0002] = id;
    if ((rxQHead_289__0002 == rxQTail_289__0002) && (rxAge_289__0002 == 0))
      rxQTail_289__0002 = (rxQTail_289__0002 + 1) % 1U;
    if ((rxQHead_289__0002 == (rxQTail_289__0002 + 1)% 1U) && (rxAge_289__0002
         != 0))
      rxQTail_289__0002 = (rxQTail_289__0002 + 1) % 1U;
    rxQHead_289__0002 = (rxQHead_289__0002 + 1 ) % 1U;
    rxAge_289__0002 = 0;
  }
}

uint8_T can_get_289__0002(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  uint8_T i;
  if (age != NULL)
    *age = rxAge_289__0002;
  if (id != NULL)
    *id = rxID_289__0002[rxQTail_289__0002];
  if (extended != NULL)
    *extended = 1U;
  if (length > 8)
    length = 8;
  if (length > rxLen_289__0002[rxQTail_289__0002])
    length = rxLen_289__0002[rxQTail_289__0002];
  if (data != NULL)
    for (i = 0; i < length; i++)
      data[i] = rxBuf_289__0002[rxQTail_289__0002][i];
  if ((rxQHead_289__0002 != (rxQTail_289__0002 + 1)% 1U) && (rxAge_289__0002 ==
       0))
    rxQTail_289__0002 = (rxQTail_289__0002 + 1) % 1U;
  else if (rxAge_289__0002 < MAX_AGE)
    rxAge_289__0002++;
  return length;
}
...
void can_send_78__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_753__0002) {
    pre_start_CAN_753__0002();
  }

  send_can_message(CAN1, extended, id, data, length);
}

void can_update_78__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_78__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_79__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_753__0002) {
    pre_start_CAN_753__0002();
...
void can_update_79__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_79__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_76__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_753__0002) {
    pre_start_CAN_753__0002();
...
void can_update_76__0005(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_76__0005(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_77__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_753__0002) {
    pre_start_CAN_753__0002();
...
void can_update_77__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_77__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_121__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_753__0002) {
    pre_start_CAN_753__0002();
...
void can_update_121__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_121__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_258__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_753__0002) {
    pre_start_CAN_753__0002();
...
void can_update_258__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_258__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_259__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_753__0002) {
    pre_start_CAN_753__0002();
...
void can_update_259__0002(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_259__0002(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_753__0002(boolean extended, uint32_t id, uint8_t * data,
  uint8_t data_len)
{
  ...
  if (!app_is_in_shutdown) {
    if (extended == 1U) {
      if ((id & 0x1FFFFFFF) == 0x18FF0180) {
        rxFn_290__0002(id, data_len, data);
      }
    }
  }
  ...
  if (!app_is_in_shutdown) {
    if (extended == 1U) {
      if ((id & 0x1FFFFFFF) == 0x18FF0080) {
        rxFn_289__0002(id, data_len, data);
      }
    }
  }
...
void post_start_CAN_753__0002(void)
{
  if (started_753__0002) {
    return;
  }
  ...
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_753__0002 );
}                                      // end post_start_CAN_753__0002
