...
/* <S7>/raptor_can_txmsg */
uint8_T txData_8__0013[1U][8U];
uint32_T txID_8__0013[1U];
uint8_T txExt_8__0013[1U];
uint8_T txLen_8__0013[1U];
uint8_T txQHead_8__0013 = 0;
uint8_T txQTail_8__0013 = 0;

/* <S8>/raptor_can_txmsg4 */
uint8_T txData_68__0013[1U][2U];
uint32_T txID_68__0013[1U];
uint8_T txExt_68__0013[1U];
uint8_T txLen_68__0013[1U];
uint8_T txQHead_68__0013 = 0;
uint8_T txQTail_68__0013 = 0;

/* <S8>/raptor_can_txmsg3 */
uint8_T txData_67__0016[1U][2U];
uint32_T txID_67__0016[1U];
uint8_T txExt_67__0016[1U];
uint8_T txLen_67__0016[1U];
uint8_T txQHead_67__0016 = 0;
uint8_T txQTail_67__0016 = 0;

/* <S10>/raptor_can_txmsg4 */
uint8_T txData_637__004[1U][8U];
uint32_T txID_637__004[1U];
uint8_T txExt_637__004[1U];
uint8_T txLen_637__004[1U];
uint8_T txQHead_637__004 = 0;
uint8_T txQTail_637__004 = 0;

/* <S10>/raptor_can_txmsg5 */
uint8_T txData_638__004[1U][8U];
uint32_T txID_638__004[1U];
uint8_T txExt_638__004[1U];
uint8_T txLen_638__004[1U];
uint8_T txQHead_638__004 = 0;
uint8_T txQTail_638__004 = 0;

/* <S10>/raptor_can_txmsg2 */
uint8_T txData_635__004[1U][8U];
uint32_T txID_635__004[1U];
uint8_T txExt_635__004[1U];
uint8_T txLen_635__004[1U];
uint8_T txQHead_635__004 = 0;
uint8_T txQTail_635__004 = 0;

/* <S9>/raptor_can_txmsg */
uint8_T txData_345__0013[1U][4U];
uint32_T txID_345__0013[1U];
uint8_T txExt_345__0013[1U];
uint8_T txLen_345__0013[1U];
uint8_T txQHead_345__0013 = 0;
uint8_T txQTail_345__0013 = 0;

/* <S6>/raptor_can_txmsg */
uint8_T txData_667__004[1U][8U];
uint32_T txID_667__004[1U];
uint8_T txExt_667__004[1U];
uint8_T txLen_667__004[1U];
uint8_T txQHead_667__004 = 0;
uint8_T txQTail_667__004 = 0;
...
/* Functions */
void pre_start_CAN_1117__0071(void)
{
}                                      // end pre_start_CAN_1117__0071
...
void can_send_8__0013(uint32_T id, uint8_T extended, uint8_T length, const
                      uint8_T *data)
{
  if (!started_1117__0071) {
    pre_start_CAN_1117__0071();
  }

  send_can_message(CAN1, extended, id, data, length);
}

void can_update_8__0013(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_8__0013(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_68__0013(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1117__0071) {
    pre_start_CAN_1117__0071();
...
void can_update_68__0013(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_68__0013(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_67__0016(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1117__0071) {
    pre_start_CAN_1117__0071();
...
void can_update_67__0016(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_67__0016(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_637__004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1117__0071) {
    pre_start_CAN_1117__0071();
...
void can_update_637__004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_637__004(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_638__004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1117__0071) {
    pre_start_CAN_1117__0071();
...
void can_update_638__004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_638__004(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_635__004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1117__0071) {
    pre_start_CAN_1117__0071();
...
void can_update_635__004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_635__004(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_345__0013(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1117__0071) {
    pre_start_CAN_1117__0071();
...
void can_update_345__0013(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_345__0013(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void can_send_667__004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!started_1117__0071) {
    pre_start_CAN_1117__0071();
...
void can_update_667__004(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
}

uint32_T can_set_period_667__004(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
void CAN_ReceiveDispatch_1117__0071(boolean extended, uint32_t id, uint8_t *
...
void post_start_CAN_1117__0071(void)
{
  if (started_1117__0071) {
    return;
  }

  started_1117__0071 = 1;
  start_CAN(CAN1, CAN_CAN1_baud_rate );
  can_register_rx_callback( CAN1, CAN_ReceiveDispatch_1117__0071 );
}                                      // end post_start_CAN_1117__0071
