...
copy Lightning_McSeas_VCU_Current_Mode.hex "C:\Users\jerod\OneDrive\Documents\School-Files\Boat_Team\GitHubFiles\Lightning_McSeas_VCU_Current_Mode_raptor_rtw\Lightning_McSeas_VCU_Current_Mode_066.hex" /Y
