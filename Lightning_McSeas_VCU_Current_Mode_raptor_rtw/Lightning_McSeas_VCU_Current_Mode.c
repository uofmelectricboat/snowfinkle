...
void Lightning_McSeas_VCU_Current_Mode_Foreground(void)
{
  ...
  /* S-Function Block:<S7>/raptor_can_txmsg */
  {
    ...
    data[3U] |= temp_shift;
    can_set_period_8__0006(0U);
    can_send_8__0006(1305U & 0x7FF, 0, 8U, &data[0]);
  }
  ...
  /* S-Function Block:<S8>/raptor_can_rxmsg */
  {
    ...
    uint32_T temp;
    can_get_472__0006(&rtb_raptor_can_rxmsg_o1, NULL, NULL, &data[0], 8);
  ...
  /* S-Function Block:<S8>/raptor_can_rxmsg2 */
  {
    ...
    uint32_T temp;
    can_get_474__0006(&rtb_raptor_can_rxmsg2_o1, NULL, NULL, &data[0], 8);
   ...
   *  Merge: '<S20>/Merge'
   */
  rtb_Merge_n = (rtb_Merge_n > 1200.0);
  ...
  /* S-Function Block:<S10>/raptor_can_txmsg */
  {
    ...
    data[0U] |= temp_shift;
    can_set_period_158__0006(0U);
    can_send_158__0006(1024U & 0x7FF, 0, 4U, &data[0]);
  }
  ...
  /* S-Function Block:<S8>/raptor_can_rxmsg1 */
  {
    ...
    uint32_T temp;
    can_get_473__0006(&rtb_raptor_can_rxmsg1_o1, NULL, NULL, &data[0], 8);
  ...
  /* S-Function Block:<S11>/raptor_can_txmsg */
  {
    ...
    data[0U] |= temp_shift;
    can_set_period_446__0009(0U);
    can_send_446__0009(218038727U & 0x1FFFFFFF, 1, 8U, &data[0]);
  }

  /* Gain: '<S11>/Gain1' incorporates:
   *  Product: '<S11>/Product'
   */
  rtb_Gain2 = rtb_raptor_can_rxmsg_o3 * rtb_Merge_d * 0.02;
  ...
  /* S-Function Block:<S11>/raptor_can_txmsg1 */
  {
    ...
    data[0U] |= temp_shift;
    can_set_period_447__0006(0U);
    can_send_447__0006(218042823U & 0x1FFFFFFF, 1, 8U, &data[0]);
  }
  ...
  /* S-Function Block:<S28>/raptor_can_txmsg */
  {
    ...
    data[0U] |= temp_shift;
    can_set_period_485__0006(0U);
    can_send_485__0006(1306U & 0x7FF, 0, 8U, &data[0]);
  }
}
