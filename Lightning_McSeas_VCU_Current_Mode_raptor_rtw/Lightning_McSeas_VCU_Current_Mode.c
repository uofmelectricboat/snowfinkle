...
void Lightning_McSeas_VCU_Current_Mode_Foreground(void)
{
  ...
  /* Gain: '<S8>/Gain2' */
  rtb_Gain2 = 51.0 * rtb_raptor_can_rxmsg1_o2;
  ...
  /* S-Function Block:<S9>/raptor_can_rxmsg */
  {
    ...
    rtb_Merge_j = (((real_T) temp / (real_T) 500.0) );
  ...
  if (rtb_Merge_j < 4.05) {
     ...
     *  Sum: '<S9>/Sum'
     */
    rtb_Merge_j = -242.0 * rtb_Merge_j + 996.1;
  ...
  /* S-Function Block:<S9>/raptor_can_txmsg1 */
  {
    ...
    if (rtb_Gain2 < 0.0000000000F)
      temp = (uint32_T)0U;
    else if (rtb_Gain2 > 255.0000000000F)
      temp = (uint32_T)255U;
    else {
      if ((real_T)rtb_Gain2 < 0)
        temp = (uint32_T)(int32_T)((rtb_Gain2));
    ...
    /* signal type is unsigned */
    if (rtb_Gain1_p < 0.0000000000F)
      temp = (uint32_T)0U;
    else if (rtb_Gain1_p > 6553.5000000000F)
      temp = (uint32_T)65535U;
    else {
      if ((real_T)rtb_Gain1_p < 0)
        temp = (uint32_T)(int32_T)((rtb_Gain1_p) * 10.0f);
      else
        temp = (uint32_T)((rtb_Gain1_p) * 10.0f);
    }
   ...
   */
  rtb_Gain1_p = rtb_raptor_can_rxmsg_o2 * rtb_Gain2 * -0.02;
  ...
  /* S-Function Block:<S11>/raptor_can_txmsg */
  {
    ...
    /* signal type is unsigned */
    if (rtb_Gain1_p < -1600.0000000000F)
      temp = (uint32_T)0U;
    else if (rtb_Gain1_p > 1676.7500000000F)
      temp = (uint32_T)65535U;
    else {
      if ((real_T)rtb_Gain1_p < 0)
        temp = (uint32_T)(int32_T)((rtb_Gain1_p- -1600.0f) * 20.0f);
      else
        temp = (uint32_T)((rtb_Gain1_p- -1600.0f) * 20.0f);
    }
   ...
   *  Product: '<S11>/Product'
   */
  rtb_Gain2 = rtb_raptor_can_rxmsg_o3_l * rtb_Gain2 * 0.02;
