...
/* Functions */
void pre_start_CAN_2067__0005(void)
{
}                                      // end pre_start_CAN_2067__0005

void CAN_ReceiveDispatch_2067__0005(boolean extended, uint32_t id, uint8_t *
  data, uint8_t data_len)
{
}

void post_start_CAN_2067__0005(void)
{
  if (started_2067__0005) {
    return;
  }

  started_2067__0005 = 1;
  start_CAN(CAN2, CAN_CAN2_baud_rate );
  can_register_rx_callback( CAN2, CAN_ReceiveDispatch_2067__0005 );
}                                      // end post_start_CAN_2067__0005
