...
copy EB_Charging_Program_Feb.hex "C:\Users\jerod\OneDrive\Documents\School-Files\Boat_Team\GitHubFiles\Charger_Config\EB_Charging_Program_Feb_raptor_rtw\EB_Charging_Program_Feb_080.hex" /Y
