...
typedef struct {
  uint8_T const ModelName[23];         /* Type : uint8_T, Storage : CONST,  */
  ...
  uint8_T const SwIdTxt[27];           /* Type : uint8_T, Storage : CONST,  */
  uint8_T const CalIdTxt[31];          /* Type : uint8_T, Storage : CONST,  */
...
#define ModelName_ELEMENTS()           (1 * 23)
