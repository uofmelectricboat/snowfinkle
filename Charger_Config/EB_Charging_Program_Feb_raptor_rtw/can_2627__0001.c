...
/* Functions */
void pre_start_CAN_2627__0001(void)
{
}                                      // end pre_start_CAN_2627__0001

void CAN_ReceiveDispatch_2627__0001(boolean extended, uint32_t id, uint8_t *
  data, uint8_t data_len)
{
}

void post_start_CAN_2627__0001(void)
{
  if (started_2627__0001) {
    return;
  }

  started_2627__0001 = 1;
  start_CAN(CAN2, CAN_CAN2_baud_rate );
  can_register_rx_callback( CAN2, CAN_ReceiveDispatch_2627__0001 );
}                                      // end post_start_CAN_2627__0001
