 ...
 * C/C++ source code generated on : Mon Apr 10 15:44:35 2023
 *
...
void EB_Charging_Program_Feb_Foreground(void)
{
  ...
  /* S-Function Block:<S4>/raptor_can_rxmsg */
  {
    ...
    uint32_T temp;
    can_get_135__0002(&rtb_raptor_can_rxmsg_o1, NULL, NULL, &data[0], 8);
  ...
  /* S-Function Block:<S4>/raptor_can_txmsg */
  {
    ...
    data[0U] |= temp_shift;
    can_set_period_137__0002(0U);
    can_send_137__0002(403105268U & 0x1FFFFFFF, 1, 8U, &data[0]);
  }
  ...
  /* S-Function Block:<S4>/raptor_can_rxmsg1 */
  {
    ...
    uint32_T temp;
    can_get_136__0002(&rtb_raptor_can_rxmsg1_o1, NULL, NULL, &data[0], 8);
  ...
  /* S-Function Block:<S4>/raptor_can_txmsg1 */
  {
    ...
    /* signal type is unsigned */
    if (90.0 < 0.0000000000F)
      temp = (uint32_T)0U;
    else if (90.0 > 6553.5000000000F)
      temp = (uint32_T)65535U;
    else {
      if ((real_T)90.0 < 0)
        temp = (uint32_T)(int32_T)((90.0) * 10.0f);
      else
        temp = (uint32_T)((90.0) * 10.0f);
    }
    ...
    data[0U] |= temp_shift;
    can_set_period_138__0002(0U);
    can_send_138__0002(403105780U & 0x1FFFFFFF, 1, 8U, &data[0]);
  }
  ...
  /* S-Function Block:<S5>/raptor_can_rxmsg */
  {
    ...
    uint32_T temp;
    can_get_216__0002(&rtb_raptor_can_rxmsg_o1_i, NULL, NULL, &data[0], 8);
  ...
  /* S-Function Block:<S5>/raptor_can_txmsg */
  {
    ...
    data[0U] |= temp_shift;
    can_set_period_217__0002(0U);
    can_send_217__0002(1024U & 0x7FF, 0, 4U, &data[0]);
  }
}
